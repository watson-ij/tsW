...
'''
python drawer.py nKs nkshortsInjet[0] 10,0,10
python drawer.py x_Ks kshortsInjet_energy[0]/jet_energy[0] 200,0,1
'''

bfiledir = './wj_out_tsWbW_1k.root'
sfiledir = './wj_out_tsWbW_1k.root'
treename = "tsW"
...
for i in range(0,100):
    #cut = "1==1"
    cut = "(abs(kshortsInjet_eta[%d])<1.4&&kshortsInjet_outR[%d]<868)||(abs(kshortsInjet_eta[%d])>1.4&&kshortsInjet_outR[%d]<2200)"%(i,i,i,i)
    #cut = "((kshortsInjet_energy[%d]/jet_energy[%d])>0.2)"%(i,i)
    print cut
    if i == 0:
