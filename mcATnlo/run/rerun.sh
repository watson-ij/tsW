...
# xrdcp hadAOD.root root://cms-xrdr.sdfarm.kr:1094///xrd/store/user/iawatson/$1/HADAOD/$2.root
# xrdcp *log root://cms-xrdr.sdfarm.kr:1094///xrd/store/user/iawatson/$1/LOG/$2.had.log
# rm hadAOD.root

echo `pwd`
cmsRun /cms/scratch/iwatson/tsW/mcATnlo/run/AOD2nanoAOD.py $1/AODSIM/$2.root > $2.nano.log 2>&1
xrdcp nanoAOD_AOD.root root://cms-xrdr.sdfarm.kr:1094///xrd/store/user/iawatson/$1/NANOAOD/$2.root
xrdcp *log root://cms-xrdr.sdfarm.kr:1094///xrd/store/user/iawatson/$1/LOG/$2.hadnano.log
rm nanoAOD_AOD.root
