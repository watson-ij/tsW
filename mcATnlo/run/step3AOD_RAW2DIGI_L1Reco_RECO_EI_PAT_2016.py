...
# with command line options: step3 --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 -n -1 --era Run2_2016 --eventcontent FEVTDEBUGHLT,AODSIM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,EI,PAT --datatier RECODEBUG,AODSIM --geometry DB:Extended --filein file:step2.root --fileout file:step3.root --no_exec
